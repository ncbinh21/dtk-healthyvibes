...
class Weight_Loss_Loader {
	 ...
	 * @return void
	 */
	public function weight_loss_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function weight_loss_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function weight_loss_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function weight_loss_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->weight_loss_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function weight_loss_load( $class ) {
