<?php
namespace Healthyvibes\Ghtk\Observer;
...
class UpdateOrderInsuranceAmount implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($order->getShippingMethod() == 'ghtk_ghtk' && $insuranceAmount != 0 && $baseInsuranceAmount != 0) {
            $order->setData(\Healthyvibes\Ghtk\Model\Carrier\Ghtk::INSURANCE_CODE, $insuranceAmount);
            $order->setData(\Healthyvibes\Ghtk\Model\Carrier\Ghtk::BASE_INSURANCE_CODE, $baseInsuranceAmount);
        }
        return $this;
    }
}
