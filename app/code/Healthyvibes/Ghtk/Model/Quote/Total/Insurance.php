...
namespace Healthyvibes\Ghtk\Model\Quote\Total;
...
class Insurance extends \Magento\Quote\Model\Quote\Address\Total\AbstractTotal
{
    ...
    public function collect(
        ...
        if ($this->helperData->getConfigValue('active') &&
            ...
            $total->setTotalAmount(\Healthyvibes\Ghtk\Model\Carrier\Ghtk::INSURANCE_CODE, $insuranceAmount);
            $total->setBaseTotalAmount(\Healthyvibes\Ghtk\Model\Carrier\Ghtk::BASE_INSURANCE_CODE, $insuranceAmount);
