...
namespace Healthyvibes\InventoryAdminUi\Controller\Adminhtml\Source;
...
class Save extends \Magento\InventoryAdminUi\Controller\Adminhtml\Source\Save
{
    ...
    private function processSave(SourceInterface $source, array $requestData)
    {
        ...
        $source['city_id'] = !empty($requestData['general']['city_id']) ? $requestData['general']['city_id'] : '';
        $source['ward'] = !empty($requestData['general']['ward']) ? $requestData['general']['ward'] : '';
        $source['ward_id'] = !empty($requestData['general']['ward_id']) ? $requestData['general']['ward_id'] : '';
        $source['domain_id'] = !empty($requestData['general']['domain_id']) ? $requestData['general']['domain_id'] : '';
        $source['shop_id_ghn'] = !empty($requestData['general']['shop_id_ghn']) ? $requestData['general']['shop_id_ghn'] : '';
