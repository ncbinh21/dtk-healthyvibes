...
namespace Healthyvibes\Banner\Model\ResourceModel\Banner;

use Healthyvibes\Banner\Api\Data\BannerInterface;
use Healthyvibes\Banner\Model\Banner;
use Healthyvibes\Banner\Model\ResourceModel\AbstractCollection;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Healthyvibes\Banner\Model\Banner::class,
            \Healthyvibes\Banner\Model\ResourceModel\Banner::class
        );
    ...
    public function addFieldToFilter($field, $condition = null)
    {
        switch ($field) {
            case "store":
                ...
                $this->getSelect()->join(
                    ['store' => $this->getTable('healthyvibes_banner_store')],
            ...
            case "customer":
                ...
                $this->getSelect()->join(
                    ['customer' => $this->getTable('healthyvibes_banner_customer_group')],
    ...
    {
        $this->join(
            ['banner_store' => $this->getTable('healthyvibes_banner_store')],
    ...
    protected function _afterLoad()
    {
        ...
        $this->performAfterLoad($this->getTable('healthyvibes_banner_store'), $entityMetadata->getLinkField());
    ...
    {
        $entityMetadata = $this->metadataPool->getMetadata(BannerInterface::class);
        $this->joinStoreRelationTable($this->getTable('healthyvibes_banner_store'), $entityMetadata->getLinkField());
    }
}
