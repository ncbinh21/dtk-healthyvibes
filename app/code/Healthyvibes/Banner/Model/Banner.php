...
class Banner extends AbstractModel implements BannerInterface, IdentityInterface
{
     ...
     */
    const BASE_IMAGE_MEDIA_PATH = 'healthyvibes/banner/image';

    /**
     * Base media path for banner's image
     */
    const BASE_VIDEO_MEDIA_PATH = 'healthyvibes/banner/video';
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'healthyvibes_banner';
     ...
     * @var string
     */
    protected $cacheTag = 'healthyvibes_banner';
     ...
     * @var string
     */
    protected $eventPrefix = 'healthyvibes_banner';
    ...
    {
        $this->_init(\Healthyvibes\Banner\Model\ResourceModel\Banner::class);
    }
