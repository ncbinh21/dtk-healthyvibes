    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Block Top'),
                'index' => 'top',
                'renderer' => 'Healthyvibes\Magicmenu\Block\Adminhtml\Helper\Renderer\Grid\Block',
                'header_css_class' => 'col-action',
                'column_css_class' => 'col-action',
            ]
        );
